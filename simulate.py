...
WINDOWWIDTH = 640
WINDOWHEIGHT = 480
FLASHSPEED = 500     # szybkość błysku w milisekundach
FLASHDELAY = 200     # opóźnienie między błyskami w milisekundach
BUTTONSIZE = 200
BUTTONGAPSIZE = 20
TIMEOUT = 4          # czas w sekundach na kliknięcie przed przegraną
...
def flashButtonAnimation(color, animationSpeed=50):
    if color == YELLOW:
        sound = BEEP1; flashColor = BRIGHTYELLOW; rectangle = YELLOWRECT
    elif color == BLUE:
        sound = BEEP2; flashColor = BRIGHTBLUE; rectangle = BLUERECT
    elif color == RED:
        sound = BEEP3; flashColor = BRIGHTRED; rectangle = REDRECT
    elif color == GREEN:
        sound = BEEP4; flashColor = BRIGHTGREEN; rectangle = GREENRECT
...
def gameOverAnimation(color=WHITE, animationSpeed=50):
    ...
    BEEP1.play(); BEEP2.play(); BEEP3.play(); BEEP4.play()
    r, g, b = color
    for _ in range(3):
        for start, end, step in ((0, 255, 1), (255, 0, -1)):
            for alpha in range(start, end, animationSpeed * step):
    ...
    msgSurf = BASICFONT.render('Game Over', True, WHITE)
    msgRect = msgSurf.get_rect()
    msgRect.center = (WINDOWWIDTH // 2, WINDOWHEIGHT // 2)
